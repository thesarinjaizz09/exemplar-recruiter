...
const mongoURI = process.env.ER_DATABASE_URL; // Specifying the db url for connecting the server to it
...
const connectToMongoDB = async () => {
    mongoose
        ...
        .then(() => {
            console.log("X--- Exemplar Recruiter database connected succesfully ---X")
            console.log(`X--- Exemplar Recruiter database connection url: ${connection_string} ---X`)
        })
